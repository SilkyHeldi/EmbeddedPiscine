...
int	main()
{
	...
	i2c_write(0b01111111); // data : only bit 0 as output
	...
	while (1)
	{
		...
		i2c_write(0b01111111); // DATA : 1 = OFF and 0 = ON : we choose IO0_3
		i2c_write(0b01011011); // port 1 output : all segments for digits
		i2c_stop();
